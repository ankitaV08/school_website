...
//conect to db
    ...
    {
        //echo "Submit pressed";
        $insert_pro="insert into classes(Standard,section,t_id) values ('$_POST[std]','$_POST[section]','$_POST[ctid]')";
        $run_pro=mysqli_query($db,$insert_pro);
        echo "<script>alert('Data inserted successfully!')</script>";
        echo "<script>window.open('classReg.php','_self')</script>";
    }
?>
...
<html>
    ...
    <div style="background-color: darkgreen; color: #FFFFFF; margin: 2%; height: 15%; width: 100%;">
     ...
     <div class="header">  
        ...
        <br>
        <h1><b>Enter class details</b></h1><br>
        <form action="classReg.php" method="post">
            <table align="center" cellpadding = "10px">
                <tr>
                    <td>Standard</td>
                    <td><input type="text" name="std" maxlength="100" placeholder="Enter your Standard here"  required>
                    
                    </td>
                </tr>
                <tr>
                    <td>Section</td>
                    <td><input type="text" name="section" maxlength="100" placeholder="Enter your section here" required/>
                    
                    </td>
                </tr>
                <tr>
                    <td>Class teacher ID</td>
                    <td><input type="text" name="ctid" maxlength="100" placeholder="Enter class teacher's ID here"  required/>
