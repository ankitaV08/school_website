...
//conect to db
    ...
    {
        echo "Submit pressed";
        $insert_pro="insert into students(name,classno,email,address,city) values ('$_POST[nm]','$_POST[cno]','$_POST[mail]','$_POST[address]','$_POST[city]')";
        $run_pro=mysqli_query($db,$insert_pro);
        echo "<script>alert('Data inserted successfully!')</script>";
        echo "<script>window.open('studentReg.php','_self')</script>";
    }
?>
     ...
     <div class="header">  
        ...
        <form action="studentReg.php" method="post">
            <table align="center" cellpadding = "10px">
                ...
                <tr>
                    <td>Class No.</td>
                    <td><input type="text" name="cno" maxlength="100" placeholder="Enter your Class ID/Number"  required/>
                    (Max 50 Characters Allowed)
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>City</td>
                    <td><input type="text" name="city" maxlength="100" placeholder="Enter your City"  required/>
                    (Max 50 Characters Allowed)
                    </td>
                </tr>
